...
% Datos para el tipo de mezcla seleccionado
...
% Reacción Química en la CAMARA DE COMBUSTION
    ...
    Cp_medio = (( E * Cp_h20 + (C * Cp_h2) + (D * Cp_o2)) / (C+D+E) )* 1e3;  % Cp media de los productos de la cc 
