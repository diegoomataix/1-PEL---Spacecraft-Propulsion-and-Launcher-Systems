...
% Gastos másicos en las bombas       
    m_bf = 1 / (1 + x(i)); % gasto másico bomba fuel / gasto total
    m_bo = x(i) / (x(i) + 1); % gasto másico bomba oxidante / gasto total
    %m_bf = 1 / (1 + OF(i)); % gasto másico bomba fuel / gasto total
    %m_bo = OF(i) / (OF(i) + 1); % gasto másico bomba oxidante / gasto total
